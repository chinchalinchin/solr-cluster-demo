...
SCRIPT_NAME='exec'
nl=$'\n'
SCRIPT_DES="Execute a string of commands inside of the \e[3mtitanic-solr\e[0m container. The command ${nl}\
    must be provided as a string enclosed in quotation marks, i.e., ${nl}${nl}\
        bash ./exec.sh \"do something in solr container\"${nl}${nl}\
    As such, make sure to start \e[3mtitanic\e[0m cluster before executing this script."
